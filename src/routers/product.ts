...
import { handleCreateProduct, handleGetAllProduct, handleGetDeleteProduct, handleGetProductAdmin, handleHardDeleteProduct, handleRestoreSoftDeleteProduct, handleSoftDeleteProduct, handleUpdateProduct } from '../controllers/product';
...
router.get('/delete/product', authenticate, handleGetDeleteProduct)
